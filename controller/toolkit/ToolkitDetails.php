...
class ToolkitDetails {
    ...
    public static function displayDetailsDesignPattern($id, $session){
        ...
        if($dp != false){
            ...
            echo "<img src=\"../img/vrac/add.png\" style=\"vertical-align:bottom;width:20px\"/>  <a href=\"#\" onClick=\"".ToolkitDisplay::cartLink($dp->getID(), "$('body')")."\"><h3>Add to my current Design Pattern</h3></a>";
